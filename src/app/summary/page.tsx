...
export default function Summary() {
  return (
    <Wrapper>
      <label id="summary-prompt" className={HEADER_STYLE}>Is this what you are looking for? </label>
      <span className="italic text-sm mb-2 text-gray-400 dark:text-gray-600">If not, please click &#34;Resubmit&#34; after edit.</span>
      <Textarea text="School zone, Sunny, Near Garden, Spacious, 4 bedrooms, 2 bathrooms, 1 Carpark" id="summary-prompt" placeholder="Please enter your description ..." />
