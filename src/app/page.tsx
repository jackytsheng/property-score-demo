...
import { HEADER_STYLE, INPUT_STYLE } from "./style";
...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center p-24">
      <label htmlFor="message" className={HEADER_STYLE}>Tell me about your dream property 🏡</label>
      <span className="italic text-sm mb-2 text-gray-400 dark:text-gray-600">Example: "Sunny, Spacious, 4 bedrooms, 2 bathrooms ..."</span>
      <textarea id="message" rows={4} maxLength={200} className={`${INPUT_STYLE} mb-4 resize-none block`} placeholder="Write your thoughts here..."></textarea>
