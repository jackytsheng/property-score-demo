...
export const PropertyCard = ({
  ...
  <a
    href={link}
    target="__blank"
    className="mb-8 flex flex-col items-center rounded-lg border border-gray-200 bg-white shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 md:max-w-xl md:flex-row"
  >
    <Image
      width={200}
      height={150}
      className="max-h-60 w-full rounded-t-lg object-cover md:h-80 md:w-48 md:rounded-none md:rounded-l-lg"
      src={src}
      alt=""
    />
